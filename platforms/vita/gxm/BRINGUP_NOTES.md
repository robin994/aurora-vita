# Historical snapshot: initial native GXM bring-up at b36768e

This document records the first standalone milestone. Its integration limits
and build instructions describe that historical revision, not the current
shared-GX backend. See [README.md](README.md) for the current contract and builds.
