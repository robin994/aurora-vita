...
bool same_texture_binding(const TextureBinding&a,const TextureBinding&b) noexcept{return a.texture==b.texture&&a.source==b.source&&a.flipX==b.flipX&&a.flipY==b.flipY&&a.forceOpaque==b.forceOpaque&&a.sampleFormat==b.sampleFormat&&same_sampler(a.sampler,b.sampler);}
#endif
}
