...
bool same_texture_binding(const TextureBinding&a,const TextureBinding&b) noexcept{return a.texture==b.texture&&a.source==b.source&&a.flipX==b.flipX&&a.flipY==b.flipY&&a.forceOpaque==b.forceOpaque&&a.sampleFormat==b.sampleFormat&&a.uvScaleX==b.uvScaleX&&a.uvScaleY==b.uvScaleY&&a.uvBiasX==b.uvBiasX&&a.uvBiasY==b.uvBiasY&&same_sampler(a.sampler,b.sampler);}
#endif
}
...
void Renderer::set_presentation_aspect(float) noexcept {}
