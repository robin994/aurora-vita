...
Handle Renderer::upload_efb_rgba(Handle existing,uint32_t width,uint32_t height,const void* rgba) noexcept {Handle out=efb_.upload_rgba(existing,width,height,rgba);invalidate_draw_state();return out;}
